...
Download the model from this [link][https://drive.google.com/file/d/1L_DbGhFqN-KBPJeTDFCAvX3RPZELJE9R/view?usp=sharing](https://huggingface.co/fangyuan/lfqa_role_classification) and place it in the `models` directory.
